...
namespace api.Controllers
{
    public static class ApiResponse
    {
        ...
        public static IActionResult Failed<T>(T Data, string message = "Failed")
        {
            return new ObjectResult(new ApiResponseTemplate<T>(false, Data, message, 200));
        }
    ...
    public class ApiResponseTemplate<T>
    {
        ...
        public ApiResponseTemplate(bool success, T data, string message = null, int statusCode = 200)
        {
            Success = success;
            Data = data;
            Message = message;
